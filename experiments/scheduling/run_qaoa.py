"""
QAOA Based Scheduling Experiment.

Run with:
    python experiments/scheduling/run_qaoa.py
"""
...
def run() -> None:
    ...
    with make_progress() as progress:
        ...
        scheduler = QAOAScheduler(
            ...
            beta=0.5,
            reps=1,
            batch_size=2,  # Optimize in batches of 2 to keep simulated qubits (2*5 = 10 qubits) low
